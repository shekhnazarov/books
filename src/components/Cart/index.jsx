...
const Cart = ({ book }) => {
  return (
    <div className="max-w-sm w-full p-8 bg-white rounded-xl mb-6 shadow-lg relative">
      <div className="">
        <div
          className="h-8 w-8 flex items-center justify-center bg-red-400 absolute -right-8 top-4"
        ...
        <div
          className="h-8 w-8 flex items-center justify-center bg-purple-700 absolute -right-8"
